...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1800000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=2, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONFIG_TITLE=ADC_SAR_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("26d4baf6-6051-413b-833b-cf339e1d5b71/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_ADC_in_net;
	wire [0:0] tmpFB_0__Pin_ADC_in_net;
	wire [0:0] tmpIO_0__Pin_ADC_in_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ADC_in_net;
	electrical [0:0] tmpSIOVREF__Pin_ADC_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ADC_in
		 (.oe(tmpOE__Pin_ADC_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_ADC_in_net[0:0]}),
		  .analog({Net_101}),
		  .io({tmpIO_0__Pin_ADC_in_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ADC_in_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ADC_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
