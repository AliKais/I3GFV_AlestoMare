...
module top ;
	...
	wire [0:0] tmpOE__Pin_Out1_net;
	wire [0:0] tmpFB_0__Pin_Out1_net;
	wire [0:0] tmpIO_0__Pin_Out1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Out1_net;
	electrical [0:0] tmpSIOVREF__Pin_Out1_net;

	cy_psoc3_pins_v1_10
		#(.id("3e55a215-9c1c-43d4-8d53-de08eb975f8a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Out1
		 (.oe(tmpOE__Pin_Out1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Out1_net[0:0]}),
		  .io({tmpIO_0__Pin_Out1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Out1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Out1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Out1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Out2_net;
	wire [0:0] tmpFB_0__Pin_Out2_net;
	wire [0:0] tmpIO_0__Pin_Out2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Out2_net;
	electrical [0:0] tmpSIOVREF__Pin_Out2_net;

	cy_psoc3_pins_v1_10
		#(.id("6fc53fbf-2070-4028-80d4-4920193f582b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Out2
		 (.oe(tmpOE__Pin_Out2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Out2_net[0:0]}),
		  .io({tmpIO_0__Pin_Out2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Out2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Out2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Out2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
